				...
				<section class="wrapper style1" style="height:500px;">
					<div class="container">
						<div id="content">
							...
							ArrayList<Liga> listAllLigas = connectionBD.listLiga();
							%>
								<article>
									
									<section class="col-6 col-12-narrower">
								<h3>Baja Liga</h3>
								<form action="operaciones.jsp?tipo=bajaliga" method="post">
									<div class="row gtr-50" >
									<center>
										<select name ="cod_liga" id="cod_liga" value="cod_liga" style="padding:10px;">
										<% for ( int i = 0; i<listAllLigas.size();i++){ %>								
										<option value="<%=listAllLigas.get(i).getCod_liga()%>"><%=listAllLigas.get(i).getNombre() %></option>
										<%} %>
										</select>
									</center>																	
									</div>
