						...
						<div id="content">
							...
							<!-- Content -->
								...
								<article>
									...
									ArrayList<Jugador> listJugador = connectionBD.listAllJugador();
								...
								<form action="operaciones.jsp?tipo=bajajugador" method="post">
									<div class="row gtr-50">
										<center>
										<select name="cod_jugador" value="cod_jugador" id="cod_jugador"style="padding: 10px">
										<%
										for ( int i = 0; i < listJugador.size(); i++){
										%>
										<option value="<%= listJugador.get(i).getCod_jugador() %>"><%= listJugador.get(i).getNombre()%></option>
										<%} %>
										</select>
										</center>																	
									</div>
