			...
			<div id="content">
				...
				<form action="operaciones.jsp?tipo=altajugador" method="post">
					<div class="row gtr-50">
						<div class="">
							<input type="text" name="nombre" id="nombre"
								placeholder="Nombre del jugador" style="width: 450px"
								; maxlength="20" />
						</div>
						<div class="">
							<input type="text" name="pierna" id="pierna"
								placeholder="Pierna buena del jugador" maxlength="9" />
						</div>
						<div>
						<center>
						...
						<div class="">
							<input type="text" name="pais" id="pais"
								placeholder="Pais del jugador" maxlength="20" />
						</div>
						<div class="">
							<input type="number" name="altura" id="altura"
								placeholder="Altura del jugador" maxlength="4" />
						</div>
					...
					<div style="padding-top: 22px;">
						<ul class="actions">
							<li><input type="submit" class="button alt" value="Dar alta" /></li>
						</ul>
					</div>
