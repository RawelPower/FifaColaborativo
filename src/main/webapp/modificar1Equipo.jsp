						...
						<div id="content">
							...
							<!-- Content -->
								...
								<article>
									...
									ArrayList<Equipo> listAllEquipo = connnectionBD.listEquipo();
									%>
									<section class="col-6 col-12-narrower">
								<h3>Equipo</h3>
								<form action="modificar2Equipo.jsp?" method="post">
									<div class="row gtr-50">		
										<center>
										<select name ="cod_equipo" id="cod_equipo" value="cod_equipo" style="padding: 10px">
