						...
						<div id="content">
							...
							<!-- Content -->
								...
								<article>
									...
									ArrayList<Liga> listAllLiga = connnectionBD.listLiga();
									%>
									<section class="col-6 col-12-narrower">
								<h3>Liga</h3>
								<form action="modificar2Liga.jsp?" method="post">
									<div class="row gtr-50">		
										<center>
										<select name ="cod_liga" id="cod_liga" value="cod_liga" style="padding: 10px">
