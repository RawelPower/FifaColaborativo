					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								Liga liga = connectionBD.getLiga_by_codeLiga(Integer.parseInt(cod_liga));
								%>
								<article>
									
									<section class="col-6 col-12-narrower">
								<h3>Modificar Liga</h3>
								<form action="operaciones.jsp?tipo=modificarLiga" method="post">
									<div class="row gtr-50">		
										
										<div class="">
											<input type="text" name="nombre" id="nombre" value="<%=liga.getNombre() %>" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
											<input type="text" name="pais" id="pais" value="<%=liga.getPais() %>" maxlength="9"/>
										</div>
										<div class="">
											<input type="hidden" name="cod_liga" id="cod_liga" value="<%=liga.getCod_liga() %>" maxlength="9"/>										
										</div>								
									</div>
