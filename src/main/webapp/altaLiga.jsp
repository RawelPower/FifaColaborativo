					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Liga</h3>
								<form action="operaciones.jsp?tipo=altaliga" method="post">
									<div class="row gtr-50">		
										
										<div class="">
											<input type="text" name="nombre" id="nombre" placeholder="Nombre de la liga" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
											<input type="text" name="pais" id="pais" placeholder="País" maxlength="9"/>
										</div>								
									</div>
