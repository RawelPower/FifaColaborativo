					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<article>
									<% 
									BDController connnectionBD = new BDController();
									ArrayList<Jugador> listAllJugador = connnectionBD.listAllJugador();
									%>
									<section class="col-6 col-12-narrower">
								<h3>Jugador</h3>
								<form action="modificar2Jugador.jsp?" method="post">
									<div class="row gtr-50">		
										<center>
										<select name ="cod_jugador" id="cod_jugador" value="cod_jugador" style="padding: 10px">
										<%for( int i = 0; i < listAllJugador.size() ; i++){ %>
										<option value="<%=listAllJugador.get(i).getCod_jugador()%>"><%=listAllJugador.get(i).getNombre() %></option>
										<%} %>
										</select>
										</center>							
									</div>
